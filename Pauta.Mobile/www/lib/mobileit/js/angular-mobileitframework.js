angular.module('templates-main', ['templates/screen.tpl', 'templates/loader.tpl', 'templates/page.tpl', 'templates/pageContent.tpl', 'templates/slideMenu.tpl', 'templates/slideMenuLeft.tpl', 'templates/slideMenuRight.tpl']);
	...
	directives.directive('mblScreen', function(MBL_CONSTANTS, $rootScope, $location) {
		return {
			...
			link: function($scope, element, attrs) {
				...
				$rootScope.mbl.screen.go = function(url) {
	...
	directives.directive('mblPageContent', function(MBL_CONSTANTS, $rootScope) {
		return {
			...
			link: function($scope, element, attrs) {
				...
				$rootScope.mbl.page.refreshScroll = function(offset) {
					...
					var myScroll = new iScroll("mblPageContentWrapper" + mblPageContentWrapperIndex, { mouseWheel: true, bounce: true, momentum: true, useTransition: true, shrinkScrollbars: 'clip' });

					if (element.height() == 0) {
						setTimeout(function() {
							element.height($(window).height() - top);
							element.addClass("mbl-height-forced");
...
(function() {
	...
	directives.directive('mblSlideMenuLeft', function(MBL_CONSTANTS) {
		return {
			restrict: 'E',
			replace: true,
			transclude: true,
...
(function() {
	...
	directives.directive('mblSlideMenuRight', function(MBL_CONSTANTS) {
		return {
			restrict: 'E',
			replace: true,
			transclude: true,
